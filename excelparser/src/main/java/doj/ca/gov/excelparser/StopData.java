...
@Table(keyspace = "stop_data", name = "stopdata_by_doj_record_id", caseSensitiveKeyspace = false, caseSensitiveTable = false)
public class StopData {
	@PartitionKey()
	
	private String Doj_Record_Id;
	...
	public String getDoj_Record_Id() {
		return Doj_Record_Id;
	}

	public void setDoj_Record_Id(String doj_Record_Id) {
		Doj_Record_Id = doj_Record_Id;
	}
